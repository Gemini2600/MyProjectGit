...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		<div class="div1">
			...
			<div class="div1_1">
				<div class="div1_1_1">
					<div class="div1_1_1_1">
						<ul>
							<li><a href="updateconsumer.jsp">${consumer.loginname}</a></li>
							<li><a href="loginHomeServlet.do">首页</a></li>
							<li><a href="quitLoginServlet.do">退出</a></li>
						</ul>
					</div>
			...
			<form action="loginHomeServlet.do" method="post">
			<div class="div1_3">
			...
			<div class="div1_4">
				...
				<div class="div1_4_11">
						...
						<input type="button" value="加入购物车" onclick="jia(${pmd.id})"/>
	...
	<a href="loginHomeServlet.do?reqType=2&pageNo=1&pageSize=4">首页</a>&nbsp;
	</c:if>
	
    <a href="loginHomeServlet.do?reqType=2&pageNo=${products.pageNo==1?products.pageNo:products.pageNo-1}&pageSize=4">上一页</a>&nbsp;
	
	<a href="loginHomeServlet.do?reqType=2&pageNo=${products.pageNo==products.totalPageSize?products.pageNo:products.pageNo+1}&pageSize=4">下一页</a>&nbsp;
	
	<a href="loginHomeServlet.do?reqType=2&pageNo=${products.totalPageSize}&pageSize=4">尾页</a>
	...
	第<select onchange="self.location.href=options[selectedIndex].value">
  		...
  		<c:when test="${products.pageNo==i+1 }">
  			<option value="loginHomeServlet.do?reqType=2&pageNo=${i+1} }&pageSize=4" selected="selected">${i+1}</option>
  		</c:when>
  		<c:otherwise>
  		<option value="loginHomeServlet.do?reqType=2&pageNo=${i+1}&pageSize=4" >${i+1}</option>
  		</c:otherwise>	
		</c:choose>
		</c:forEach>
		</select>页
